          ...
          <ul class="mt-6">
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Article de blog</span>
              </a>
            </li>
          </ul>
          <ul>
          ...
          <ul class="mt-6">
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Liste des adresses Mail</span>
              </a>
            </li>
          </ul>
          <ul>
                        ...
                        <table class="w-full whitespace-no-wrap">
                            <thead>
                                <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                    ...
                                    <th class="px-4 py-3 cursor-pointer" onclick="sortTable(1)">Questions</th>
                                    <th class="px-4 py-3 cursor-pointer" onclick="sortTable(2)">Réponses</th>
                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                ...
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        <a href="/modifier-question/{{ $question->id }}" class="btn btn-info">Modifier</a>
                                        <a href="/supprimer-question/{{ $question->id }}" class="btn btn-danger">Supprimer </a>
                                    </td>
                                </tr>
