  ...
  <main class="main">
    ...
    <div class="page-title" data-aos="fade">
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Titre du blog</h1>
              <p class="mb-0">Description de l'article</p>
            </div>
          </div>
        </div>
      </div>
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            <li><a href="/blog">Retour à la page principale</a></li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-4 sidebar">
          ...
          <div class="widgets-container">
            ...
            <div class="recent-posts-widget widget-item">
              ...
              <div class="post-item">
                <img src="assets1/img/blog/blog-recent-1.jpg" alt="" class="flex-shrink-0">
                <div>
              ...
              <div class="post-item">
                <img src="assets1/img/blog/blog-recent-2.jpg" alt="" class="flex-shrink-0">
                <div>
              ...
              <div class="post-item">
                <img src="assets1/img/blog/blog-recent-3.jpg" alt="" class="flex-shrink-0">
                <div>
              ...
              <div class="post-item">
                <img src="assets1/img/blog/blog-recent-4.jpg" alt="" class="flex-shrink-0">
                <div>
              ...
              <div class="post-item">
                <img src="assets1/img/blog/blog-recent-5.jpg" alt="" class="flex-shrink-0">
                <div>
